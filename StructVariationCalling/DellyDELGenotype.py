...
def Define_DellyDELGenotype_Output():
	command=[
		'sites=${outpath4proj}/StructVariationCalling/all/DellyMergeDEL/all.DEL.bcf\n',
...
if __name__ == '__main__':
	...
	step='DellyDELGenotype'
	commands=Define_DellyDELGenotype_Output()
        ### write shell scripts

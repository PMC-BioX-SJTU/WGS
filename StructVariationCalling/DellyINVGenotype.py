...
def Define_DellyINVGenotype_Output():
	command=[
		'sites=${outpath4proj}/StructVariationCalling/all/DellyMergeINV/all.INV.bcf\n',
...
if __name__ == '__main__':
	...
	step='DellyINVGenotype'
	commands=Define_DellyINVGenotype_Output()
        ### write shell scripts
